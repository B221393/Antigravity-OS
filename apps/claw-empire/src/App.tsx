...
export default function App() {
  ...
  // Force language reset from ko to ja if detected
  useMemo(() => {
    if (typeof window !== "undefined") {
      const stored = window.localStorage.getItem("climpire.language");
      if (stored === "ko") {
        window.localStorage.setItem("climpire.language", "ja");
        window.localStorage.setItem("climpire.language.user_set", "ja");
      }
    }
  }, []);
  ...
  return (
    ...
    >
      <AppOverlays
        ...
        activeOfficeWorkflowPack={settings.officeWorkflowPack ?? "development"}
        onChangeWorkflowPack={handleOfficeWorkflowPackChange}
